...
workers.validateCheckData = function(originalCheckData) {
  ...
  console.log(originalCheckData.id, originalCheckData.userPhone, originalCheckData.protocol, originalCheckData.url, originalCheckData.method, originalCheckData.successCode, originalCheckData.timeoutSeconds)
  if (originalCheckData.id &&
    ...
    console.log('Error: one of the checks is not properly formmated')
  }
};
...
workers.alertUserToStatusChange = function(newCheckData) {
  ...
  helpers.sendTwilioSms(newCheckData.userPhone, msg, function(err) {
    if (!err) {
      ...
      console.log('Error : Could not sent sms alert')
    }
  });
};
          ...
          if (!err) {
            ...
            _logs.truncate(logId, function(err) {
              if (!err) {
                ...
                console.log('Error truncatng log file');
              }
            });
          } else {
            console.log('Error compressing one fo the log files', err);
          }
        })
      });
    } else {
